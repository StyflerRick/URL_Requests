...
def dolar_reais_hoje():
    ...
    if DolarCota_str:
        ...
        dollar_hoje = float(DolarCota_str)
        if __name__ == "__main__":
            print('1 dolar hoje vale R${}'.format(dollar_hoje))
    else:
...
def BTC_Real():
    global BTCCota
    # Faz a requisição HTTP para a página que contém o valor atual do BTC
    ...
    # Extrai o valor da cotação BTC/Real da resposta HTTP usando uma expressão regular
